                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            ...
                            <select wire:model="product_id" 
                                    id="product_id"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('product_id') border-red-500 @enderror">
                    ...
                    @if($quantity && $unit_price)
                        <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-2xl font-bold text-blue-900">R$ {{ number_format($quantity * $unit_price, 2, ',', '.') }}</span>
                            </div>
                        </div>
                    @endif
