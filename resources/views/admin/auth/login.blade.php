...
<body class="relative min-h-screen flex items-center justify-center p-4 overflow-hidden"
    ...
    <div class="absolute inset-0 overflow-hidden">
        ...
        <div class="absolute bottom-20 right-20 w-96 h-96 bg-white/10 rounded-full blur-3xl animate-pulse"
            style="animation-delay: 1s;"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-white/5 rounded-full blur-3xl animate-pulse"
            style="animation-delay: 2s;"></div>
    </div>

    <!-- Content -->
    <div class="max-w-md w-full relative z-10">
        <div class="modern-card overflow-hidden animate-fadeInUp">
            ...
            <div class="p-8">
                <div class="text-center mb-8">
                    <h3 class="text-2xl font-black text-gray-900">Área Administrativa</h3>
                    <p class="text-gray-500 mt-2">Faça login com suas credenciais</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                class="input-modern w-full pl-20" placeholder="admin@sistema.com" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-3 text-sm font-semibold text-gray-700">Manter-me
                            conectado</label>
                    </div>
                ...
                <div class="mt-8 text-center">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white text-gray-500 font-medium">Retornar</span>
                        </div>
                    </div>
