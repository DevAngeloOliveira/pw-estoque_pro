...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
    <!-- Modern Navbar -->
    <nav class="fixed w-full glass-effect shadow-lg z-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <span class="text-2xl font-black text-gray-900 tracking-tight">Estoque Pro</span>
                        <p class="text-xs text-gray-500 font-medium">Sistema de Gestão</p>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('login') }}"
                        class="px-6 py-2.5 text-gray-700 hover:text-indigo-600 font-bold transition-all duration-300 rounded-xl hover:bg-indigo-50">
                        Entrar
                    </a>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="slide-in-left">
                    ...
                    <h1 class="text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
                        Gestão de Estoque
                    ...
                    <p class="text-xl text-gray-600 mb-8 leading-relaxed font-medium">
                        ...
                        <span class="text-indigo-600 font-bold">relatórios em tempo real</span> e
                        <span class="text-purple-600 font-bold">análises detalhadas</span>.
                    </p>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mb-8">
                        ...
                        <a href="#features"
                            class="btn-modern bg-white text-gray-700 border-2 border-gray-200 hover:border-indigo-600 hover:text-indigo-600 text-lg">
                    ...
                    <div class="flex flex-wrap gap-6 text-sm">
                        <div class="flex items-center px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-100">
                            <i class="fas fa-check-circle text-green-500 mr-2 text-lg"></i>
                            <span class="font-semibold text-gray-700">Sem cartão de crédito</span>
                        </div>
                        <div class="flex items-center px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-100">
                            <i class="fas fa-check-circle text-green-500 mr-2 text-lg"></i>
                            <span class="font-semibold text-gray-700">Configuração em 2 minutos</span>
                        </div>
                        <div class="flex items-center px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-100">
                            <i class="fas fa-shield-alt text-indigo-600 mr-2 text-lg"></i>
                            <span class="font-semibold text-gray-700">100% Seguro</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="slide-in-right relative">
                    <div class="relative float-animation">
                        ...
                        <!-- Main image -->
                        <div class="relative modern-card p-4 bg-gradient-to-br from-white to-gray-50">
                            ...
                            <!-- Stats overlay -->
                            <div class="absolute top-8 right-8 modern-card bg-white p-4 shadow-xl">
                                <div class="flex items-center space-x-3">
                                    <div
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold">Crescimento</p>
                                        <p class="text-2xl font-black text-gray-900">+47%</p>
                                    </div>
                                </div>
                            </div>

                            <div class="absolute bottom-8 left-8 modern-card bg-white p-4 shadow-xl">
                                <div class="flex items-center space-x-3">
                                    <div
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold">Produtos</p>
    ...
    <section id="features" class="py-24 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-20">
                <div
                    class="inline-flex items-center px-4 py-2 bg-indigo-50 border border-indigo-200 rounded-full mb-4">
                    <i class="fas fa-star text-indigo-600 mr-2"></i>
                    <span class="text-sm font-bold text-indigo-700">RECURSOS</span>
                </div>
                <h2 class="text-5xl font-black text-gray-900 mb-6">Recursos Poderosos</h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div
                    class="feature-card modern-card p-8 bg-gradient-to-br from-white to-blue-50 border border-blue-100">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-4">Relatórios em Tempo Real</h3>
                ...
                <!-- Feature 2 -->
                <div
                    class="feature-card modern-card p-8 bg-gradient-to-br from-white to-purple-50 border border-purple-100">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-4">Multi-Empresas</h3>
                    <p class="text-gray-600 leading-relaxed font-medium">
                ...
                <!-- Feature 3 -->
                <div
                    class="feature-card modern-card p-8 bg-gradient-to-br from-white to-green-50 border border-green-100">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-4">Segurança Avançada</h3>
                    <p class="text-gray-600 leading-relaxed font-medium">
                ...
                <!-- Feature 4 -->
                <div class="feature-card modern-card p-8 bg-gradient-to-br from-white to-red-50 border border-red-100">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-4">Alertas Inteligentes</h3>
                    <p class="text-gray-600 leading-relaxed font-medium">
                ...
                <!-- Feature 5 -->
                <div
                    class="feature-card modern-card p-8 bg-gradient-to-br from-white to-yellow-50 border border-yellow-100">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-4">Totalmente Responsivo</h3>
                    <p class="text-gray-600 leading-relaxed font-medium">
                        Acesse de qualquer dispositivo - desktop, tablet ou smartphone com interface adaptativa.
                    </p>
                    <div class="mt-6 flex items-center text-yellow-600 font-bold text-sm">
                        <span>Saiba mais</span>
                        <i class="fas fa-arrow-right ml-2"></i>
                    </div>
                </div>
                ...
                <!-- Feature 6 -->
                <div
                    class="feature-card modern-card p-8 bg-gradient-to-br from-white to-indigo-50 border border-indigo-100">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-4">Backup Automático</h3>
                    <p class="text-gray-600 leading-relaxed font-medium">
